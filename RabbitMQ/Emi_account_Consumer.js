...
// console.log( `from Emi_Account_Consumer file with process Id ${process.pid} \r\n`);
...
//             //insert your logic 
//             let data = receive.customerdetail.emailid;
//             console.log(data,"******************")
//         const Emails = email.Emi(data);
//         logger.info("get the document data", Emails);
//         //logger.info("mail is called");
