...
exports.loanDocumentPublisher = async (payloadDetail, queName) => {
  try {
    //  console.log("AK");
    //  console.log(payloadDetail);
    amqpconn.connect(Url).then(async (channel) => {
      try {
        ...
        console.log("message from loan document publisher :", payloadDetail);
      } catch (err) {
        console.log(err);
      }
    });
    ...
    logger.info("err in loanDocument_publisher");
    throw err;
  }
};
