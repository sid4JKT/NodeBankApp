...
const doc_name = path.join(__dirname, '..','pdfdocuments','loanaccount.pdf');


 // Create a document
 exports.LoanPDF = async(payload) =>{
console.log('line 13')
...
doc.pipe(fs.createWriteStream(doc_name));
  ...
  doc
  .fontSize(20).text("Welcome to Loan Account", 90, 90,{align:'center'});
